node{
    ...
    stage('git code checkout'){
        try{
            ...
            ${BUILD_URL}''', subject: 'Job ${JOB_NAME} ${BUILD_NUMBER} is failed', to: 'noninandeibam64@gmail.com'
        }
    }
    ...
    stage('Pushing it ot the DockerHub'){
        ...
        sh "${dockerCMD} login -u noni64 -p ${dockerHubPassword}"
        sh "${dockerCMD} push noni64/insure-me:${tagName}"
