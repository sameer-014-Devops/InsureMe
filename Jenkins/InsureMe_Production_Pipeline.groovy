...
pipeline{
    ...
    stages {
            ...
            steps {
                ...
                script {
                    ...
                    if (podExists) {
                        ...
                        sh """ssh $User_Name@$KubeM_Pvt_IP kubectl apply -f insuremedeploy.yaml"""
                        sleep 5
                    ...
                    sleep 15
                    echo "http://${env.KubeW01_Pub_IP}:30016"
                    echo "http://${env.KubeW02_Pub_IP}:30016"
                    Deploy_Main = true
                }
            }
            post{
        ...
        stage ('Cleaning_Production_Workspace'){
            ...
            steps{
                echo '**********Cleaning InsureMe Production workspace**********'
                cleanWs()
                deleteDir()
            }
        }
